...
The first of our workshops to go 100% online, this covers the [Discovery] and [Exploration] sessions of the [Core Agendashift][core] workshop and features both the Lite and Classic editions of our Clean Language-inspired coaching game [15-minute FOTO]. [More...][learning_the_language_of_outcomes]

### 2. [Strategic Mapping with Outcomes]

This short workshop is centered on the ‘string’ of three mapping exercises from the the [Mapping] session of the [Agendashift Deep Dive][deep_dive] workshop. [More...][strategic_mapping_with_outcomes]

### 3. [Stories, Hypotheses, and A3]

This short workshop features the [Agendashift Experiment A3 Template][experiment_a3]. It is based on the [Elaboration] session of the [Core Agendashift][core] workshop, with additional material from the *[Impact!]* and [Wholehearted:OKR] workshops. [More...][stories_hypotheses_a3]
